...
function FeaturesCard(props) { 
  ...
  return (
    ...
    <>
     {
      state ? 
       (
      <div
      className={`grid gap-[14px] m-4 py-7 w-[100%] h-[280px] md:h-[250px] lg:h-[320px]
      xl:h-[260px] sm:w-fit 
      px-2 col-span-2 md:col-span-1 font-montserrat duration-300
    ...
    >
      ...
      <p className='text-lg md:text-md px-5'>{props.description}</p>
    </div>)
      : 
      (
        <div
        className={`grid gap-[14px] m-4 py-7 w-[100%] sm:w-fit h-[280px] md:h-[250px] lg:h-[320px]
        xl:h-[260px] px-2 col-span-2 md:col-span-1 
