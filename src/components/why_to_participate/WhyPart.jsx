...
function WhyPart2() {
    ...
    hover:text-transparent hover:bg-clip-text transition-all underlined-text'> WHY TO PARTICIPATE IN AVINYA 2024</h1>

            <div className='grid grid-cols-4 mx-[24%] md:grid-cols-3 md:w-[70%] md:mx-[15%] gap-12
      md:gap-16'>

                <div className="grid gap-[14px] m-4 bg-purple-600 py-7 w-[100%] sm:w-fit px-2
        ...
        rounded-tr-xl transition-all rounded-b-2xl hover:scale-[103%] hover:translate-x-2 translate-y-2">
                    <h3 className='text-4xl md:text-xl font-semibold font-serif'>GET INSPIRED</h3>
                    <p className='text-xl md:text-md'>Compete with creative project ideas and get inspiration for your next project.</p>
                </div>
