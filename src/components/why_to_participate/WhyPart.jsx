...
function WhyPart() {
    ...
    return (
        <div data-aos="zoom-in" id="whyJoinAvinya" className='mt-28 md:mt-36 overflow-x-hidden
         overflow-hidden'>

            <h1 className='text-3xl md:text-5xl text-white pt-4 text-center 
    font-bold hover:scale-[101%] transition-all headerAkira pb-16 max-w-3xl mx-auto'>
            
            WHY TO PARTICIPATE IN AVINYA 2024
