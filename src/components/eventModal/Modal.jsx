...
//                                     <h2 className='text-slate-950 text-xl my-3 font-bold'>{eventTime}</h2>
//                                 </div>
...
//                                         className='ml-[25%]' />
//                                     <img className='text-5xl text-black ml-8' />
//                                     <h2 className='text-slate-950 text-2xl my-3 font-bold'>{eventDate}</h2>
//                                 </div>


//                                 <div className='md:ml-[6%] mt-6 detailsLarge'>
//                                     <FaLocationDot className='text-5xl items-center text-black ml-[35%]' />
//                                     <h2 className='text-slate-950 text-xl my-3 font-bold text-center'>{eventVenue}</h2>
//                                 </div>
