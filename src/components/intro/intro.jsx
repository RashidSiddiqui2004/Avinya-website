  ...
  return (
    <div className={styles.box} id='about'>
      <div className={styles.overlap_group}>
        ...
        AVINYA, the annual flagship event of Devcomm NSUT, is set to captivate tech enthusiasts with an a week-long tech fest spanning from January 18th to 21st, 2024, at NSUT's main campus. It will be an opportunity to dive into a world of mind-bending tech competitions, including a 24-hour themed hackathon, blind coding challenge, eSports, graphic designing, and a plethora of other engaging activities. Beyond the tech realm, the fest promises to be a vibrant celebration with entertaining events like DJ Nights and stand-up comedy featuring some of India's top artists.
        </p>
        <div className={styles.rectangle_1} />
