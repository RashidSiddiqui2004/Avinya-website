...
function Sponsors() {
  return (
    <div>
      <h2 className='text-6xl sm:text-4xl text-center pt-20 text-green-200 
      ...
      <div>
        <h2 className='text-6xl sm:text-4xl text-center mt-16 mb-5 font-bold font-fairdisplay
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 items-center
         mx-[40%] sm:mx-14 mt-3 md:mx-96'>
          ...
          <div className='flex flex-row gap-2 rounded-lg lg:bg-slate-600 w-full md:w-fit'>
            ...
            <p className='text-white text-4xl sm:text-2xl font-semibold text-center my-4 px-4'>polygon</p>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        items-center ml-[40%] sm:ml-[20%] md:ml-[18%] lg:ml-8'>
          ...
          <div className='flex flex-row gap-2 rounded-lg lg:bg-slate-600 w-full md:w-fit'>
            ...
            <p className='text-white text-4xl sm:text-2xl font-semibold text-center my-4 px-4'>filecoin</p>
          </div>
          <div className='flex flex-row gap-2 rounded-lg lg:bg-slate-600 w-full md:w-fit'>
            <img src="/tezos.png" alt="" className='h-16 rounded-md' />
            <p className='text-white text-4xl sm:text-2xl font-semibold text-center my-4 px-8'>Tezos</p>
          </div>
          <div className='flex flex-row gap-2 rounded-lg lg:bg-slate-600 w-full md:w-fit'>
            <img src="/celo.png" alt="" className='h-16 rounded-md px-2 py-2 ml-3' />
            <p className='text-white text-4xl sm:text-2xl font-semibold text-center my-4 pr-6'>Celo</p>
          </div>
      ...
      <div className='pt-32'>
        ...
        items-center ml-[23%] sm:ml-[20%] md:ml-[18%] lg:ml-8'>
